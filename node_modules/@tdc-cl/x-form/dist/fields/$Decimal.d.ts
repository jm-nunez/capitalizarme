...
export declare const $Decimal: import("./CustomField").I$CustomField<string, Decimal>;
...
export declare function inferAllowedDecimalsFrom(inputProps: InputProps): number | undefined;
export declare function parseDecimal(input: string, allowedDecimals: number, min: Decimal, max: Decimal, locale: XFormLocale): Result<Decimal>;
